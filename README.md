...
This repository ships a runnable MVP with a Rust core and multiple (optional) adapters.
...
- Go/Java adapter skeletons (placeholders)
- Python provider adapters (OpenAI / OpenRouter / Ollama)
...
- Bash-compatible shell for `tools/generate-protos.sh` (macOS/Linux/WSL/Git Bash)
...
- Rust builds generate gRPC code automatically.
- Python/Go/Java stubs are generated by the script above.
...
Adapters are gRPC sidecars that register with the Rust core registry. The core stays authoritative; adapters are not peers.

### Language adapters

- Python: [`adapters/pagi-adapter-python/`](adapters/pagi-adapter-python/)
- Go (skeleton): [`adapters/pagi-adapter-go/`](adapters/pagi-adapter-go/)
- Java (skeleton): [`adapters/pagi-adapter-java/`](adapters/pagi-adapter-java/)

### Provider adapters (Python)

These are optional provider integrations that can be used by adapters/middleware:

- OpenAI: [`adapters/pagi-provider-openai/`](adapters/pagi-provider-openai/)
- OpenRouter: [`adapters/pagi-provider-openrouter/`](adapters/pagi-provider-openrouter/)
- Ollama: [`adapters/pagi-provider-ollama/`](adapters/pagi-provider-ollama/)
